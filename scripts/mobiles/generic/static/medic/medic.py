...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('medic')
	...
	templates = Vector()
	templates.add('object/mobile/shared_dressed_doctor_trainer_human_female_01.iff')
	...
	core.spawnService.addMobileTemplate('medic', mobileTemplate)
	return