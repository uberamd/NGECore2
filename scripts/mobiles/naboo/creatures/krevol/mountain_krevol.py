...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('mountain_krevol')
	...
	mobileTemplate.setSocialGroup("krevol mountain")
	...
	core.spawnService.addMobileTemplate('mountain_krevol', mobileTemplate)
	return