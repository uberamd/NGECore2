...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('epic_montrus')
	...
	weapontemplate = WeaponTemplate('object/weapon/melee/unarmed/shared_unarmed_default.iff', WeaponType.CARBINE, 1.0, 6, 'energy')
	...
	core.spawnService.addMobileTemplate('epic_montrus', mobileTemplate)
	return