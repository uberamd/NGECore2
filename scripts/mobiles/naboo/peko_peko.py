...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('peko_peko')
	...
	mobileTemplate.setMeatAmount(105)
	...
	mobileTemplate.setSocialGroup("peko peko")
	...
	core.spawnService.addMobileTemplate('peko_peko', mobileTemplate)
	return