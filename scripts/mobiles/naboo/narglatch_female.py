...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('narglatch_female')
	...
	templates = Vector()
	templates.add('object/mobile/shared_narglatch_female.iff')
	...
	core.spawnService.addMobileTemplate('narglatch_female', mobileTemplate)
	return