...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('gurk_tracker')
	...
	mobileTemplate.setHideAmount(277)
	mobileTemplate.setBoneType("Mammal Bone")
	mobileTemplate.setBoneAmount(302)
	...
	core.spawnService.addMobileTemplate('gurk_tracker', mobileTemplate)
	return