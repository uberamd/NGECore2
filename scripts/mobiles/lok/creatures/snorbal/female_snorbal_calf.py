...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('female_snorbal_calf')
	...
	mobileTemplate.setMeatAmount(545)
	mobileTemplate.setHideType("Leathery Hide")
	mobileTemplate.setHideAmount(440)
	mobileTemplate.setBoneType("Mamma Bone")
	mobileTemplate.setBoneAmount(400)
	mobileTemplate.setMilkType("Wild Milk")
	mobileTemplate.setMilkAmount(25)
	...
	core.spawnService.addMobileTemplate('female_snorbal_calf', mobileTemplate)
	return