...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('kimogila_hatchling')
	...
	mobileTemplate.setHideAmount(625)
	...
	templates = Vector()
	templates.add('object/mobile/shared_kimogila_hatchling.iff')
	...
	core.spawnService.addMobileTemplate('kimogila_hatchling', mobileTemplate)
	return