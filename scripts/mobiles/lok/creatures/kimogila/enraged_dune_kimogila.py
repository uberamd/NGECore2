...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('enraged_dune_kimogila')
	...
	mobileTemplate.setMeatAmount(1600)
	mobileTemplate.setHideType("Leathery Hide")
	mobileTemplate.setHideAmount(1450)
	...
	core.spawnService.addMobileTemplate('enraged_dune_kimogila', mobileTemplate)
	return