...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('gurk_gatherer')
	...
	mobileTemplate.setHideAmount(276)
	mobileTemplate.setBoneType("Mammal Bone")
	mobileTemplate.setBoneAmount(301)
	...
	core.spawnService.addMobileTemplate('gurk_gatherer', mobileTemplate)
	return