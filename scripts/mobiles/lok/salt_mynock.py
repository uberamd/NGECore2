...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('salt_mynock')
	...
	templates = Vector()
	templates.add('object/mobile/shared_salt_mynock.iff')
	...
	core.spawnService.addMobileTemplate('salt_mynock', mobileTemplate)
	return