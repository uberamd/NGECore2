...
def addTemplate(core):
	...
	mobileTemplate.setCreatureName('enraged_kimogila')
	...
	mobileTemplate.setHideAmount(1400)
	...
	templates = Vector()
	templates.add('object/mobile/shared_giant_kimogila.iff')
	...
	core.spawnService.addMobileTemplate('enraged_kimogila', mobileTemplate)
	return